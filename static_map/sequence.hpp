...
{
public:
    IterImpl() : m_tree(nullptr), m_item(nullptr) {}
    ~IterImpl() = default;
...
class IteratorBase : public std::iterator<std::bidirectional_iterator_tag, TData>
{
public:
...
public:
    class const_iterator : public TIteratorBase
    {
    public:
    ...
    class const_reverse_iterator : public TIteratorBase
    {
    public:
        typedef TIteratorBase Base;
